...
function checkEcosystemStability() {
  if (pademelonsHistory.length >= historyLength) {
    ...
    if (Math.abs(avgPademelons - 50) < 10 && Math.abs(avgDevils - 10) < 5 && Math.abs(avgBandicoots - 30) < 10 &&
        avgPademelons > 0 && avgDevils > 0 && avgBandicoots > 0) { // Ensure none are zero
  ...
  if (stabilityAchievement && !stabilityAchievement.achieved) {
    if (frameCount >= stabilityAchievement.target && grass > 0 && pademelons > 0 && devils > 0 && bandicoots > 0) { // Ensure none are zero
  ...
  if (masterEcologistAchievement && !masterEcologistAchievement.achieved) {
    if (frameCount >= masterEcologistAchievement.target && grass > 0 && pademelons > 0 && devils > 0 && bandicoots > 0) { // Ensure none are zero
